...
forceload add 1061 1859 1142 1925
forceload add 10000 10000 10200 10200
title @a subtitle "clone..."
clone 1061 -64 1859 1142 0 1925 10000 -64 10000
...
fill 10082 100 10067 10200 -54 10000 air
title @a subtitle "fill grass_block2..."
fill 10082 -54 10067 10200 -54 10000 grass_block
title @a subtitle "fill upper_air..."
fill 10082 1 10067 10000 100 10000 air
forceload remove 1061 1859 1142 1925
title @a reset
title @a title {"text":"Jungle Temple","color":"gold"}
title @a subtitle {"text":"made by Sirius_22","color":"yellow"}
tp @a 10052 -43 10033
spawnpoint @a 10052 -43 10033
scoreboard players operation @a D_game_timer = @a D_game_ready
##store map##
scoreboard players set @a D_map_select 37
