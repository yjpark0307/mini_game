...
forceload add 1355 1134 1425 1200
forceload add 10000 10000 10200 10200
title @a subtitle "clone..."
clone 1355 -64 1134 1425 -10 1200 10000 -64 10000
...
fill 10071 100 10067 10200 -54 10000 air
title @a subtitle "fill grass_block2..."
fill 10071 -54 10067 10200 -54 10000 grass_block
title @a subtitle "fill upper_air..."
fill 10071 -9 10067 10000 100 10000 air
forceload remove 1355 1134 1425 1200
title @a reset
tp @a 10041 -30 10052
spawnpoint @a 10041 -30 10052
scoreboard players operation @a D_game_timer = @a D_game_ready
title @a title {"text":"Nether Castle","color":"gold"}
title @a subtitle {"text":"made by Sririus_22","color":"yellow"}

##store map##
scoreboard players set @a D_map_select 25
