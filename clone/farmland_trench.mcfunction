...
forceload add 1743 1173 1845 1275
forceload add 10000 10000 10200 10200
title @a subtitle "clone..."
clone 1743 -64 1173 1845 -10 1275 10000 -64 10000
